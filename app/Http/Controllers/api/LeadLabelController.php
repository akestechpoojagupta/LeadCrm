...
class LeadLabelController extends Controller
{
...
//=============================> Store Create Lead Label Detials Into db =========================>
        if($validator->passes()) {
            ...
            $response = LeadLabel::create($data);
            if($response){
...
//=============================> Store Update Lead Label Detials Into db =========================>
        if($validator->passes()) {
            ...
            $response = LeadLabel::where('id',$request->id)->update($data);
            if($response){
...
//===============================>Lead label Delete Code Start================================>
    public function delete($id){   
        ...
        $response = LeadLabel::where('id',$id)->delete();
